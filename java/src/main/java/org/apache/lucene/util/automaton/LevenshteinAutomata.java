...
//
//    Automaton a = new Automaton(36, 24);
//    int lastState;
//    if (prefix != null) {
//      // Insert prefix
...
//  }
//
//  private void toDot(Automaton a, int k, int i) {
//    String s = a.toDot();
//    try {
//      String dotFile = String.format("/tmp/FST/resource/cat_%d_%d.dot", k, i);
//      FileOutputStream stream = new FileOutputStream(dotFile, false);
//      stream.write(s.getBytes());
//      stream.close();
//      Process exec = new ProcessBuilder().command("dot", "-Tpng", dotFile).start();
//      InputStream is = exec.getInputStream();
//      Files.copy(is, Paths.get(String.format("/tmp/FST/resource/cat_%d_%d.png", k, i)));
//    } catch (Exception e) {
//      e.printStackTrace();
//    }
//  }
...
//    LevenshteinAutomata cat = new LevenshteinAutomata("cat", true);
//    Automaton automaton = cat.toAutomaton(1);
//
//  }
//}
